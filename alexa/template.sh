#!/bin/sh
SET_EMAIL='[EMAIL_HERE]'
SET_PASSWORD='[PASSWORD_HERE]'
SET_MFA_SECRET='[MFA_SECRET]'
SET_LANGUAGE='en-US'
...
# browser identity, grab from console with `console.log(window.navigator.userAgent)`
SET_BROWSER='Mozilla/5.0 (X11; Ubuntu; Linux aarch64; rv:83.0) Gecko/20100101 Firefox/83.0'
#SET_BROWSER='Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:83.0) Gecko/20100101 Firefox/83.0'
