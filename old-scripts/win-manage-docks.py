...
def main():
  ...
  try:
    ...
    print('cmd /c pscp -P 22 -pw ' + os.getenv('PI8_PASS') + ' -r \"' + source + '\" codabool@192.168.0.207:/mnt/sd1/ven/jellyfin/new')
    os.system('cmd /c pscp -P 22 -pw ' + os.getenv('PI8_PASS') + ' -r \"' + source + '\" codabool@192.168.0.207:/mnt/sd1/ven/jellyfin/new')
