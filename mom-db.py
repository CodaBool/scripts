...
try:
  ...
  videos = re.sub('b|\'|n|\\\\', '', str(subprocess.check_output("/usr/bin/python3 /home/codabool/scripts/count-simple.py /media/book/media/ n", shell=True))) # requires sudo for drive
